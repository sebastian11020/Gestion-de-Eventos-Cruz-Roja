...
export default function LoginCR() {
    ...
    return (
      ...
      `}
        >
            {/* Aura decorativa */}
            <div className="pointer-events-none absolute inset-0 blur-3xl opacity-40 mix-blend-overlay"
                 style={{
                     background:
                ...
                >
                    <CardHeader className="space-y-4 pb-2">
                        ...
                        <div className="flex items-center justify-center gap-3">
                            <div className="size-12 rounded-2xl bg-white grid place-items-center shadow ring-1 ring-blue-200">
                                <svg viewBox="0 0 24 24" className="size-7 text-red-600" aria-hidden="true">
                                    <path fill="currentColor" d="M10 3h4v7h7v4h-7v7h-4v-7H3v-4h7z" />
                                </svg>
                            </div>
                            <div className="text-center">
                                <p className="text-sm font-medium text-blue-900/80">Cruz Roja Colombiana</p>
                            </div>
                        </div>
                        <div className="text-center">
                    ...
                    <CardContent className="space-y-6 pt-0">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="document" className="text-blue-900">Documento</Label>
                            <Input
                                id="document"
                                type="text"
