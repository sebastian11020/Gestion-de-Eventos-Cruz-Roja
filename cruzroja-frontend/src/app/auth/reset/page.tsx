...
export default function ResetPasswordPage() {
    ...
    async function onSubmit(e: React.FormEvent) {
        e.preventDefault();
        if (!validPassword(pw)) return toast.error("La contraseña debe tener mínimo 8 caracteres.");
            ...
            <section className="w-full max-w-md">
                    ...
                    <div className="grid gap-2 mb-3">
                        ...
                        <div className="mt-1">
                            ...
                            <div className="mt-1 flex items-center justify-between text-xs text-slate-500">
                                <span>Fortaleza: <span className="font-medium">{scoreLabel(score)}</span></span>
                ...
                Guardando…
                    ...
                    <p className="mt-4 text-center text-xs text-slate-500">
                        Por seguridad, te pediremos iniciar sesión nuevamente después del cambio.
                    </p>
                </form>
            </section>
        </main>
