...
export default function ProfilePage() {
    ...
    return (
        <div className="p-6 space-y-6">
          ...
          <span className={`grid size-10 place-items-center rounded-lg ${monthIconClasses}`}>
          ...
          <span className="grid size-10 place-items-center rounded-lg bg-blue-50 ring-1 ring-blue-200 text-blue-600">
            ...
            >
                ...
                {/* EDITABLES */}
                <h3 className="text-base font-semibold text-gray-900">Datos editables</h3>
                ...
                {/* AYUDA VISUAL */}
                <div
                    className="flex items-start gap-3 rounded-lg bg-blue-50/60 p-3 text-sm text-blue-900 ring-1 ring-blue-200">
                    <ShieldCheck className="mt-0.5 size-4 shrink-0"/>
                    <p>
                        Solo puedes editar <b>celular</b>, <b>EPS</b>, <b>tipo de
                        afiliación</b>, <b>dirección</b>, <b>zona</b>, <b>municipio</b> y <b>contacto de emergencia</b>.
                        Los demás campos son informativos.
                    </p>
                </div>
            ...
            {/* LOADING SIMPLE */}
            {loading && <div className="text-sm text-gray-500">Cargando perfil...</div>}
        </div>
    );
}
