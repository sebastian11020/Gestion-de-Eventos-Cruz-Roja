        ...
        <div className="fixed inset-0 z-[100]">
            ...
            <div className="absolute left-1/2 top-1/2 w-[95vw] max-w-3xl -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-white shadow-2xl overflow-hidden">
                ...
                <div className="max-h[65vh] md:max-h-[65vh] overflow-y-auto px-6 pb-6 pt-4">
                    {step === 0 && <StepIdentification form={form} handleChange={handleChange} />}
                    ...
                    {step === 3 && <StepEpsEmergency form={form} eps={eps} handleChange={handleChange} handleNested={handleNested} />}
                    {step === 4 && <StepReview form={form} cityMap={cityMap} epsMap={epsMap} />}
                </div>
