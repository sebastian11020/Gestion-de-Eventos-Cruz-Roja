...
import type { SectionalNode, GroupNode, ProgramItem } from "@/types/programType";
    ...
    return (
        ...
        >
            ...
            <div className="grid gap-1.5">
                <label htmlFor="sectionalCat" className="text-sm font-medium text-gray-800">
                    Sede
                </label>
                <select
                    id="sectionalCat"
            ...
            {/* Programa */}
            <div className="grid gap-1.5">
                <label htmlFor="programCat" className="text-sm font-medium text-gray-800">
                    Programa
                </label>
                <select
                    id="programCat"
                ...
                >
                    <option value="" disabled>
                        {form.group ? "Selecciona un programa…" : "Primero elige una agrupación"}
                    </option>
