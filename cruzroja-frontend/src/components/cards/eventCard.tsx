...
export function EventCard({
                              id, title, description, inHistory = false, date, capacity, leader, state, streetAddress,city,department,
                              isLeader, isInscrit, isEdit, showSuscribe, onSubscribe,startDate,endDate, onViewEnrolled, onDelete,
    ...
    const canEdit = !inHistory && (!flags.isOngoing || (flags.isOngoing && isEdit));
        ...
        <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-200 overflow-hidden flex flex-col border border-gray-100">
                ...
                <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        {canEdit && (<Button
                            ...
                            title={canEdit ? "Editar evento" : "Solo el líder puede editar cuando está en curso"}
                        >
            ...
            <EditEventDialog
                ...
                initial={{
                    ...
                    attendant: leader?.id ?? "",
                    skill_quota:
                        skillQuotas?.map((q) => ({ id: String(q.id), name: q.name, quantity: Number(q.quantity) })) ?? [],
                }}
