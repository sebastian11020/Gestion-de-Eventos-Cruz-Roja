...
export function StepReview({
    ...
    return (
        <section className="space-y-3">
            <p className="text-sm text-gray-600">Revisa la información antes de guardar.</p>
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                ...
                <div className="rounded-lg border p-3">
                    <h5 className="font-medium text-gray-800 mb-2">Ubicación & Contacto</h5>
                    <ul className="text-sm text-gray-700 space-y-1">
                        <li>
                ...
                <div className="rounded-lg border p-3">
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                        ...
                        <li>
                            <strong>Programa:</strong> {programMap.get(String(form.id_program)) ?? "—"}
                        </li>
                    </ul>
                </div>
                <div className="rounded-lg border p-3">
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                        <li>
                            <strong>EPS:</strong> {epsMap ? epsMap.get(String(form.id_eps)) ?? "—" : form.id_eps || "—"} ({form.type_affiliation || "—"})
                        </li>
                        <li>
                            <strong>Emergencia:</strong> {form.emergencyContact.name || "—"} ({form.emergencyContact.relationShip || "—"}) - {form.emergencyContact.phone || "—"}
                        </li>
                    </ul>
                </div>
            </div>
