                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                        <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
                            <div>
                                ...
                                <p className="text-xs text-gray-500">Horas acumuladas del mes</p>
                            </div>
                            {list.length > 0 && (
                                <div className="text-[11px] text-gray-500">{list.length} registros</div>
                            )}
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full text-sm">
                                ...
                                <tr>
                                    ...
                                    <th className="px-4 py-2 text-right font-medium w-24">Horas</th>
                                </tr>
                                </thead>
                                <tbody>
                                {list.length === 0 ? (
                          ...
                          >
                            {idx + 1}
                                            ...
                                            <td className="px-4 py-2 max-w-[520px] truncate" title={p.name}>
